...
$query = mysqli_query($connessione_al_server,"SELECT a.*,b.name,b.lastname,b.id FROM ads as a INNER JOIN userdata AS b ON a.userId=b.id WHERE a.id="."'" .$_POST['id'] ."'")  //per selezionare nel db l'utente e pw che abbiamo appena scritto nel log
