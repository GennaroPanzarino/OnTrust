...
$query = mysqli_query($connessione_al_server,"SELECT title,body,price,data,imgPath FROM ads WHERE id="."'" .$_POST['id'] ."'")  //per selezionare nel db l'utente e pw che abbiamo appena scritto nel log
