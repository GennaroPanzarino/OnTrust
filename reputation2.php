...
if(isset($_POST["option"]) && $_POST["option"]==0){
  $query = mysqli_query($connessione_al_server,"SELECT rating AS currentRating FROM ratings WHERE reviewedId=".$_POST["id"]." AND reviewerId=".$_SESSION["userid"]."")
  ...
  $query = mysqli_query($connessione_al_server,"SELECT reputation FROM userdata WHERE id=".$_POST["id"]."")
  or DIE('query non riuscita'.mysql_error());
